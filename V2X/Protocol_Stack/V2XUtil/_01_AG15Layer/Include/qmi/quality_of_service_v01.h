...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.0.c1.3/Main/modem_proc/qmimsgs/qos/api/quality_of_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define QOS_V01_IDL_MINOR_VERS 0x0E
...
typedef struct {
  ...
  /**<   Data services error value returned by the IOCTL/lower layers. Refer to
     the DS error numbers in \xhyperref{[80-V6415-1]80-V6415-1} for the possible
 ...
 */
  ...
  */
  ...
  /**<   QoS Class Identifier (QCI) is a required parameter to request QoS in LTE
       ...
       For more detailed information, refer to 3GPP \hyperrf[TA23.203]{TA 23.203}.
  */
