...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.0.c1.3/Main/modem_proc/qmimsgs/dfs/api/data_filter_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue May  2 2017 (Spin 0)
...
#include "../../../_01_AG15Layer/Include/qmi/data_common_v01.h"
#include "../../Include/qmi-framework/qmi_idl_lib.h"
...
#define DFS_V01_IDL_MINOR_VERS 0x0B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DFS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DFS_V01_MAX_MESSAGE_ID 0x0038
/**
    @}
  */
...
typedef enum {
  ...
  DFS_IP_FAMILY_IPV4V6_V01 = 0x10, /**<  IPv4 and IPv6; only applicable for remote socket requests  */
...
typedef struct {
  ...
  /**<   Depending on the IP version set, either the IPv4 or the IPv6 information is valid. Values:\n
      ...
      - DFS_IP_FAMILY_IPV4V6 (0x10) --  IPv4 and IPv6; only applicable for remote socket requests 
 */
...
typedef enum {
  ...
  DFS_PROTO_TCPUDP_V01 = 0xFF, /**<  TCP and UDP protocol; only applicable for remote socket requests  */
...
typedef struct {
 ...
 implies that no transport level protocol parameters are valid. Values:\n
      ...
      - DFS_PROTO_TCPUDP (0xFF) --  TCP and UDP protocol; only applicable for remote socket requests 
 */
...
typedef enum {
  ...
  DFS_REMOTE_SOCKET_HANDLING_V0_V01 = 0x00, /**<  Basic support for remote socket allocation 
       to handle ephemeral port binding with no special
       preferences; version 0 is the default value \n  */
  DFS_REMOTE_SOCKET_HANDLING_V1_V01 = 0x01, /**<  Version 1 supports negotiating of additional
       port preferences on top of version 0  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Removes all filters associated with previously added handles for powersave. */
typedef struct {
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Removes all filters associated with previously added handles for powersave. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<   The TE reports the supported remote socket handling version to 
 the modem. Values: \n
      - DFS_REMOTE_SOCKET_HANDLING_V0 (0x00) --  Basic support for remote socket allocation 
       to handle ephemeral port binding with no special
       preferences; version 0 is the default value \n 
      - DFS_REMOTE_SOCKET_HANDLING_V1 (0x01) --  Version 1 supports negotiating of additional
       port preferences on top of version 0 
 */
...
typedef enum {
   ...
   */
  DFS_PORT_PROP_SYMMETRIC_V01 = 0x02, /**<  Symmetric ports, i.e., the same port number is used for
   V4-TCP, V4-UDP, V6-TCP, and V6-UDP
   */
...
typedef struct {
  ...
  /**<   Port allocation properties. Values:\n
      ...
      - DFS_PORT_PROP_SYMMETRIC (0x02) --  Symmetric ports, i.e., the same port number is used for
   V4-TCP, V4-UDP, V6-TCP, and V6-UDP
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Remote Socket Request Identifier */
  uint8_t request_identifier_valid;  /**< Must be set to true if request_identifier is being passed */
  uint16_t request_identifier;
  /**<    Request identifier from the modem that must be used by the TE to
        correlate the QMI_DFS_REMOTE_SOCKET_ALLOCATED_REQ from the TE.
  */
  ...
  /**<    \n
        (Special port preferences required to be honored by the TE for this remote 
        socket request from the modem.)
   */
...
typedef struct {
  ...
  uint8_t request_identifier_valid;  /**< Must be set to true if request_identifier is being passed */
  uint16_t request_identifier;
  /**<    Request identifier sent by the modem in QMI_DFS_REMOTE_SOCKET_REQUEST_IND
        and used to correlate the indication with this request message.
   */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Queries the capabilities supported by the QMI_DFS service. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Queries the capabilities supported by the QMI_DFS service. */
typedef struct {
  ...
  */
  ...
  /**<   Provides the remote socket capability version supported by the modem. Values: \n
      - DFS_REMOTE_SOCKET_HANDLING_V0 (0x00) --  Basic support for remote socket allocation 
       to handle ephemeral port binding with no special
       preferences; version 0 is the default value \n 
      - DFS_REMOTE_SOCKET_HANDLING_V1 (0x01) --  Version 1 supports negotiating of additional
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Removes all mo exceptional filters associated with previously added 
           handles. */
typedef struct {
  ...
  uint32_t filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles to the filter rules to remove. */
}dfs_remove_mo_exceptional_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Removes all mo exceptional filters associated with previously added 
           handles. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}dfs_remove_mo_exceptional_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Adds a list of filters for MO exceptional data. */
typedef struct {
  ...
  dfs_filter_rule_type_v01 filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n (List of filter rules.) */
}dfs_add_mo_exceptional_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Adds a list of filters for MO exceptional data. */
typedef struct {
 ...
 is returned when the error is QMI_ERR_INVALID_ARG. Values:\n
      ...
      - QMI_DFS_FILTER_PARAM_AH_SPI (0x0000000000010000) --  Authentication header SPI 
 */
}dfs_add_mo_exceptional_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_DFS_ADD_MO_EXCEPTIONAL_FILTERS_V01 
...
//#define REMOVE_QMI_DFS_REMOVE_MO_EXCEPTIONAL_FILTERS_V01 
...
#define QMI_DFS_REMOVE_MO_EXCEPTIONAL_FILTERS_REQ_V01 0x0037
#define QMI_DFS_REMOVE_MO_EXCEPTIONAL_FILTERS_RESP_V01 0x0037
#define QMI_DFS_ADD_MO_EXCEPTIONAL_FILTERS_REQ_V01 0x0038
#define QMI_DFS_ADD_MO_EXCEPTIONAL_FILTERS_RESP_V01 0x0038
/**
    @}
  */
