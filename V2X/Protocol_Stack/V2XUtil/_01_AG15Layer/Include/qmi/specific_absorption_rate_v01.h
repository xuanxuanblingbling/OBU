...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.0.c1.3/Main/modem_proc/qmimsgs/sar/api/specific_absorption_rate_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SAR_V01_IDL_MINOR_VERS 0x04
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SAR_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SAR_V01_MAX_MESSAGE_ID 0x0021
/**
    @}
  */
...
typedef struct {
  ...
  /**<  
     Bitmask of mmWave modules to disable specified. Bits turned on denote
     modules whose emission will be disabled
     
     module_disable_bitmask = 0x3 will mean modules 0 and 1 will be disabled,
     all others will be enabled.
  */
