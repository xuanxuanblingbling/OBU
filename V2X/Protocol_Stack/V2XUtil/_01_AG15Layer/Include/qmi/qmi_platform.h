...
/******************************************************************************
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2007-2010, 2013-2014, 2018 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#include <sys/un.h>
#include <sys/types.h>
#include "../../../_01_AG15Layer/Include/qmi/qmi_port_defs.h"
...
/* Disable all logging on external AP */
  #define   QMI_ERR_MSG_0(...) do {break;} while(0);
  #define   QMI_ERR_MSG_1(...) do {break;} while(0);
  #define   QMI_ERR_MSG_2(...) do {break;} while(0);
  #define   QMI_ERR_MSG_3(...) do {break;} while(0);
  #define   QMI_ERR_MSG_4(...) do {break;} while(0);

  #define   QMI_DEBUG_MSG_0(...) do {break;} while(0);
  #define   QMI_DEBUG_MSG_1(...) do {break;} while(0);
  #define   QMI_DEBUG_MSG_2(...) do {break;} while(0);
  #define   QMI_DEBUG_MSG_3(...) do {break;} while(0);
  #define   QMI_DEBUG_MSG_4(...) do {break;} while(0);
  #define   QMI_DEBUG_MSG(...) do {break;} while(0);
