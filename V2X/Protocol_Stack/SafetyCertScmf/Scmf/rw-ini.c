...
BOOL SecCopyFile(LPCSTR lpExistingFileName, // name of an existing file
...
**±ž×¢£º
************************************************************************/
INT SecGetLine(LPSTR pLine, DWORD dwOffset, DWORD dwSize)
{
    int len = 0;
    int len2 = 0;
...
BOOL SecIsComment(LPCSTR pLine)
{
...
**返回：
		...
		0 - 不是
************************************************************************/
BOOL SecIsSection(LPCSTR pLine)
{
    if (pLine && '[' == *pLine)
        return TRUE;
    return FALSE;
...
**±ž×¢£º
************************************************************************/
BOOL SecIsSectionName(LPCSTR pLine, LPCSTR pSection)
{
...
**备注：
************************************************************************/
BOOL SecIsKey(LPSTR pLine, LPCSTR pKeyName, LPSTR *pValue, DWORD *dwValLen)
{
    LPSTR pEqual = NULL;
...
************************************************************************/
INT SecReadIniFile(LPCSTR lpFileName)
{
    int nReturn = 0;
    struct stat stat;
    int fdFile = 0;
...
**备注：
************************************************************************/
DWORD SecGetString(LPCSTR lpAppName, LPCSTR lpKeyName,
...
************************************************************************/
void SecWriteLine(INT hOutput, LPCSTR pLine)
{
    if (pLine)
    {
...
************************************************************************/
BOOL SecWritePrivateProfileString(
    LPCSTR lpAppName,
    LPCSTR lpKeyName,
    LPCSTR lpString,
    LPCSTR lpFileName)
