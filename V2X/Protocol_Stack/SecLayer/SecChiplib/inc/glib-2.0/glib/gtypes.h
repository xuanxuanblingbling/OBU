...
#define GUINT16_SWAP_LE_BE_IA32(val) \
	(G_GNUC_EXTENSION({ guint16 __v, __x = ((guint16) (val));		\
...
#define GUINT32_SWAP_LE_BE_IA32(val) \
	(G_GNUC_EXTENSION({ guint32 __v, __x = ((guint32) (val));		\
	      if (__builtin_constant_p (__x))			\
...
#define GUINT64_SWAP_LE_BE_IA32(val) \
	(G_GNUC_EXTENSION({ union { guint64 __ll;					\
...
#define GUINT64_SWAP_LE_BE_IA64(val) \
	(G_GNUC_EXTENSION({ guint64 __v, __x = ((guint64) (val));		\
	   if (__builtin_constant_p (__x))			\
