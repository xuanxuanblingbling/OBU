...
int SW_versionHASHSUM(void)
{
    ...
    SUM += atoi(tmpstring);
	memcpy(tmpstring,&pVDSVersion->valuestring[12],8);
    ...
    SUM += atoi(tmpstring);
	memcpy(tmpstring,&pNETVersion->valuestring[12],8);
    ...
    SUM += atoi(tmpstring);
	memcpy(tmpstring,&pSYSVersion->valuestring[12],8);
    ...
    SUM += atoi(tmpstring);
	memcpy(tmpstring,&pV2XVersion->valuestring[12],8);
