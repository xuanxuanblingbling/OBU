...
#define WJV2_MAX_LIST_INTERSECTIONSTATE_LEN 16 /* 与协议不一致 协议为32 暂定为16 */
...
#define WJV2_MAX_LIST_ROADPOINT_LEN 6 /* 与协议不一致 协议为31 暂定为6 */
...
#define WJV2_MAX_LIST_REGULATORYSPEEDLIMITNUM_LEN 4 /* 与协议不一致 协议为9 暂定为4 */
...
#define WJV2_MAX_LIST_LANE_LEN 8    /* 与协议不一致 协议为32 暂定为8 */
...
#define WJV2_MAX_LIST_MOVEMENT_LEN 4 /* 与协议不一致 协议为32 暂定为4 */
...
#define WJV2_MAX_LIST_LINK_LEN 4 /* 与协议不一致 协议为32 暂定为4 */
...
#define WJV2_MAX_LIST_PATHHISTORYPOINT_LEN 8 /* 与协议不一致 协议为23 暂定为8 */
...
#define WJV2_MAX_LIST_POSITIONOFFSETLLV_LEN 8 /* 与协议不一致 协议为32 暂定为8 */
...
#define WJV2_MAX_LIST_REFERENCELINK_LEN 8         /* 与协议不一致 协议为16 暂定为8 */
...
#define WJV2_MAX_LIST_NODE_LEN 4 /* 与协议不一致 协议为32 暂定为4 */
...
#define WJV2_MAX_LIST_PassedPos_LEN 512 /*Over 200 decode faild, such as 201*/
